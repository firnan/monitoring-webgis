...
.add-data-style {
  ...
  <body>
    <div class="login">
      <form id="demo" style="display:none" method="post" action="aksilogin.php">
      <center><b>Login</b></center>
        ...
        <tr>
        <center><input type="submit" name="login" value="Login" style=""></center>
        </tr>
      </form>
      <button type="button" onclick="document.getElementById('demo').style.display='block'; this.style.display='none';">Login</button>
    </div>
